...
function addInserter(imageUrl, bbcode, title, id='icon') 
{
    $('.custom-iconizer:last').after('<a class="custom-iconizer" href="javascript:void(0);" onclick="replaceText(\'' +
        ...
        imageUrl + '" alt="Insert ' +
        title + ' symbol" title="Insert ' +
        title + ' symbol" style="background-image: url(https://bitcointalk.org/Themes/custom1/images/bbc/bbc_bg.gif); margin: 1px 2px 1px 1px;" align="bottom" height="22" width="23"></a>');
}
